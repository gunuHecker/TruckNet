  ...
  return (
    <div className="flex min-h-screen bg-gray-900 text-white">
      ...
      <main className="flex-1 p-8">
        <div className="w-full max-w-lg bg-gray-800 shadow-2xl rounded-xl p-6 mx-auto">
          <h2 className="text-3xl font-bold text-blue-400 text-center mb-6">
            🚛 Provide Trucker Details
          </h2>

          {message && (
            <p className="mb-4 text-center font-medium text-lg text-green-400">
              {message}
            </p>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full p-3 border border-gray-700 rounded-lg shadow-sm bg-gray-700 text-white focus:ring-2 focus:ring-blue-500"
              />
            </div>
