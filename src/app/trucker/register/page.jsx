...
//     try {
//       const res = await fetch("/api/auth/trucker/register", {
//         method: "POST",
...
//       router.replace("/trucker/provideDetails"); // Use replace() instead of push()
//     } catch (error) {
      ...
      <div className="w-full max-w-md bg-gray-800 shadow-2xl rounded-xl p-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-300">
            ...
            trucker to find loads, bid, and track shipments seamlessly.
          </p>
        </div>
